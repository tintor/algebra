...
TEST_CASE("segment_vs_segment_squared_distance - stress") {
    ...
    for (int i = 0; i < 10'000; i++) {
        ...
        test_segment_segment_squared_distance(a, b, c, d);

        // touching
        test_segment_segment_squared_distance(a, b, a, b);
        test_segment_segment_squared_distance(a, b, a, c);
        const auto ab4 = lerp(a, b, 0.4_q);
        const auto ab6 = lerp(a, b, 0.6_q);
        test_segment_segment_squared_distance(a, b, ab4, c);

        // degenerate
        test_segment_segment_squared_distance(a, a, b, c);
        test_segment_segment_squared_distance(a, a, b, b);
        test_segment_segment_squared_distance(a, a, a, c);

        // colinear
        test_segment_segment_squared_distance(a, b, b, ab4);
        test_segment_segment_squared_distance(a, ab4, ab6, b);
        test_segment_segment_squared_distance(a, ab6, ab4, b);
        test_segment_segment_squared_distance(a, b, ab4, ab6);
    }
}
